...
public class Data_Show extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        homen.setText(" شقه  " + SingletonDataShow.getInstance().getFlat());
        ...
        LinearLayout linearDataShowPhone = (LinearLayout) findViewById(R.id.linearDataShowPhone);
        ...
        if (SingletonDataShow.getInstance().getPapa().equals("e") && SingletonDataShow.getInstance().getMama().equals("e") && SingletonDataShow.getInstance().getPhone().equals("e"))
            linearDataShowPhone.setVisibility(View.GONE);
